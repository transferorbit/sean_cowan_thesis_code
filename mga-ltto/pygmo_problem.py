...
class MGALowThrustTrajectoryOptimizationProblem:
    ...
    def __init__(self,
        ...
        self.number_of_legs = len(transfer_body_order) - 1

        self.no_of_free_parameters = no_of_free_parameters
        self.total_no_of_free_coefficients = self.no_of_free_parameters*3*(self.no_of_gas+1)
    ...
    def get_bounds(self):
        ...
        lower_bounds.append(1) # departure velocity
        for _ in range(self.no_of_gas + 1): # time of flight
        ...
        for _ in range(self.number_of_legs): # number of revolutions
    ...
    def get_nix(self):
        return self.number_of_legs # number of revolution parameters
    ...
    def post_processing_states(self, 
        ...
        # indexes
        time_of_flight_index = 2 + self.no_of_gas + 1
        free_coefficient_index = time_of_flight_index + self.total_no_of_free_coefficients
        planet_identifier_index = free_coefficient_index + self.no_of_gas
        revolution_index = planet_identifier_index + self.number_of_legs
        ...
        leg_free_parameters = np.concatenate(np.array([np.append(number_of_revolutions[i],
            ...
            in range(self.no_of_gas+1)])).reshape((self.no_of_gas+1, 1 + 3*
