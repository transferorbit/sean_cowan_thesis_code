...
def create_modified_system_of_bodies_validation(bodies=["Sun", "Mercury", "Venus", "Earth"]):
    ...
    # it 3 (from esa_news_link) with WRONG state
    # departure_state = [ 6.88315759e+10, 1.20841767e+11, 7.51757613e+08, -2.95265439e+04, 1.35800034e+04, 2.12127622e+02]
    # arrival_state = [ 6.82995385e+10, 1.21085229e+11, 7.55569670e+08, -2.95887095e+04, 1.34713021e+04, 2.11436578e+02]

    # it 3 correct?
    departure_state = [6.76214409e+10, 1.21391962e+11, 7.60398687e+08, -2.96672409e+04, 1.33327114e+04, 2.10546046e+02]
    arrival_state = [6.70868798e+10, 1.21630966e+11, 7.64182122e+08, -2.97283747e+04, 1.32232850e+04, 2.09836491e+02]
    frame_origin = 'Sun'
    frame_orientation = 'ECLIPJ2000'
