...
class MGALowThrustTrajectoryOptimizationProblem:
    ...
    def fitness(self, design_parameter_vector : list):
        ...
        # depart_body=  "Earth" # defined depending on problem
        departure_elements = (self.depart_semi_major_axis, self.depart_eccentricity) # defined
        # depending on problem
        # target_body = "Jupiter"# defined depending on problem 
